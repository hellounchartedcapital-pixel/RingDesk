...
export function Hero() {
  return (
    <section className="relative bg-white">
      ...
      <div className="mx-auto max-w-4xl px-6 pb-24 pt-20 text-center sm:pt-28 lg:pb-32 lg:pt-32">
        ...
        <p className="mx-auto mt-6 max-w-2xl text-balance text-lg leading-relaxed text-[color:var(--brand-muted)] sm:text-xl">
        ...
        >
          ...
          {/* ⚠️ ACTION REQUIRED: Tony will record this audio after Vapi build */}
          <audio
            controls
            preload="none"
